...
class _ManualPreviewScreenState extends State<ManualPreviewScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await AppServices.history.upsert(HistoryField.description, widget.entry.description);
      await AppServices.history.upsert(HistoryField.source, widget.entry.source);
      await AppServices.history.upsert(HistoryField.category, widget.entry.category);
          ...
          children: [
            ...
            _Card(
              ...
              children: [
                ...
                if ((e.barcodeText ?? '').trim().isNotEmpty) _Row('Barcode text', e.barcodeText!.trim()),
              ],
            ),
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: scheme.onSurface, fontSize: 26, fontWeight: FontWeight.w900),
                  ),
                ],
              ),
            ),
